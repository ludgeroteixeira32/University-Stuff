// Implementação da DoubleLinkedList
import java.util.Iterator;

public class DoubleLinkedList<AnyType> implements Iterable<AnyType>,Lista<AnyType> {
    ...
    public Iterator iterator() {
        return new DoubleLinkedListIterator<AnyType>(firsElement);
    ...
    */
    private class DoubleLinkedListIterator<AnyType> implements Iterator<AnyType> {
        ...
        private DoubleLinkedListIterator(Nodulo<AnyType> x) {
            element = x;
        }
