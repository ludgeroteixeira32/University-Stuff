...
public class ABPTree<AnyType extends Comparable<? super AnyType>> implements Iterable<AnyType> {
    ...
    // Atraves do método compareTo
    //vai comparar os 2 nomes dos contactos
    // se a comparação dos contactos for maior que 0 insere á direita
    //se a comparação for menor insere á esquerda
    ...
    public class ABPIterator<AnyType> implements Iterator<AnyType> {
        ...
        public AnyType next() {
            ...
            if (currentNode.dir != null){
              choiceNodes.push(currentNode.dir);
